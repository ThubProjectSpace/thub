	    	...
	    	<div class="nav-wrapper">
	     		...
	     		<a href="#" data-target="mobile-demo" class="sidenav-trigger black-text"><i class="material-icons black-text">menu</i></a>
	      		<ul class="right hide-on-med-and-down">
	        		...
	        		<li class="center"><a class="black-text dropdown-trigger" data-target="dropdown1" href="logout.php"><?php echo $email; ?></a></li>
  				...
  				<div class="row">
  					<div class="col s12 m3 13 hide-on-small-only" style="max-height: 100%;">
  						<ul>
  							...
  							<li style="line-height: 40px;"><a id="sm" class="black-text" href="#social_media_settings">Social links</a></li>
  						</ul>
  					</div>
  					<div class="col s12 m12 13 hide-on-med-and-up">
  					<ul id="tabs-swipe-demo" class="tabs">
    					<li class="tab col s3" id=""><a class="black-text" href="#profile_settings">Profile</a></li>
    					<li class="tab col s3"><a class="black-text" href="#picture_settings">Picture</a></li>
    					<li class="tab col s3"><a class="black-text" href="#social_media_settings">Social Media</a></li>
  					</ul>
  					</div>
  						...
  						<form action="updateprofile.php" method="post">
	  						<div class="row">
	  							<div class="input-field col s12 m8 13">
	  								<input type="text" name="username" value="<?php echo $rows['first_name'].' '.$rows['last_name']; ?>" readonly id="username">
	  								<label for="username">Username</label>
	  							</div>
	  						</div>
	  						<div class="row">
	  							<div class="input-field col s12 m8 13">
	  								<input type="text" name="dob" value="<?php echo $rows['dateofbirth']; ?>" placeholder="DD-MM-YYYY" id="dateofbirth">
	  						...
	  						<div class="row">
	  							<div class="input-field col s12 m8 13">
	  								<input type="text" name="location" value="<?php echo $rows['location']; ?>" placeholder="Location" id="location">
  					...
  					<div id="picture_settings" class="col s12 m9 13">
						...
						<form action="image.php" method="post" enctype="multipart/form-data">
							<div class="row">
  							...
  							<div class="right">
  								<button class="btn-flat" name="submit" id="gg" style="border-radius:16px;border:1px solid black;">click</button>
  							</div>
  						</form>
  					</div>
  					<div id="social_media_settings" class="col s12 m9 13" style="padding-top:0px;">
  						<?php
  							$social = "SELECT * FROM sociallink WHERE id= '$id'";
  							$social_query = mysqli_query($conn,$social) or die(mysqli_error($conn));
  							while($rows = mysqli_fetch_array($social_query))
  							{
  						?>
  						<form action="social_media_links.php" method="post">
  							...
  							<div class="row">
  								<div class="input-field col s12 m8 13">
  									<input type="text" value="<?php echo $rows['facebook']; ?>" name="facebook_link" value="" placeholder="http://www.facebook.com/xxx" id="facebook">
  									<label for="facebook">Facebook</label>
  								</div>
  							</div>
  							<div class="row">
  								<div class="input-field col s12 m8 13">
  									<input type="text" name="twitter_link" value="<?php echo $rows['twitter']; ?>" placeholder="http://www.twitter.com/xxx" id="twitter">
  									<label for="twitter">Twitter</label>
  								</div>
  							</div>
  							<div class="row">
  								<div class="input-field col s12 m8 13">
  									<input type="text" name="linkedin_link" value="<?php echo $rows['linkedin']; ?>" placeholder="http://www.linkedin.com/xxx" id="linkedin">
  									<label for="linkedin">Linkedin</label>
  								</div>
  							</div>
  							<div class="row">
  								<div class="input-field col s12 m8 13">
  									<input type="text" name="googleplus_link" value="<?php echo $rows['googleplus']; ?>" placeholder="http://www.googleplus.com/xxx" id="googleplus">
