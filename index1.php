        ...
        <section>
            <nav class=" onscroll transparent" style="position:fixed;z-index: 1;box-shadow: none;-webkit-transition:background-color 2s; transition: background-color 2s;">
                <div class="nav-wrapper">
                    <a href="#!" class="brand-logo textcolor hide-on-med-and-down" style="padding:10px;">
                        <img class="img-responsive" src="main.jpg" width="150" height="30">
                    </a>
                            ...
                            <form class="container" action="login.php" method="post">
                                <div class="row z-depth-4"  style="padding:10px;background-color:white;border-radius:10px;">
                                    ...
                                    <div class="input-field col s12 m12 13">
                                        <input class="validate" type="email" placeholder="Email Id" name="email" id="email">
        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m3 13 center ">
                    <img src="student1.jpg" width="100" height="100" class="img-responsive circle">
                    <p class="center">sai yaswanth</p>
                </div>
                <div class="col s12 m3 13 center">
                    <img src="student1.jpg" width="100" height="100" class="img-responsive circle">
                    <p class="center">Kiran</p>
                </div>
                <div class="col s12 m3 13 center">
                    <img src="student1.jpg" width="100" height="100" class="img-responsive circle">
                    <p class="center">gayathri</p>
                </div>
                <div class="col s12 m3 13 center">
                    <img src="student1.jpg" width="100" height="100" class="img-responsive circle">
                    <p class="center">Haritha</p>
                </div>
            </div>
        </div>
	...
	<div id="modal1" class="modal" style="height:150%;width:65%;">
		<div class="modal-content center">
			...
			<div class="input-field col s12 m12 13">
				...
				<input id="icon_prefix" type="text" name="roll" class="validate">
			...
			<div class="input-field col s12 m6 13">
				<i class="material-icons prefix">lock</i>
				<input id="icon_prefix" type="password" name="cpassword" class="validate">
