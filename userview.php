		...
		<div class="container">
			...
			<div class="row">
				<div class="col s12 m12 13 center" style="padding:30px 0px 30px 0px;">
					<img class="img-responsive circle" width="100" height="100" src="uploads/<?php echo $sql_fetch['image']; ?>">
					<p style="font-weight: 600;"><?php echo $sql_fetch['first_name'].' '.$sql_fetch['last_name']; ?></p>
				</div>
			</div>
		</div>
	</div>
